-- CreateEnum
CREATE TYPE "ModelTypeEnum" AS ENUM ('Men', 'Women', 'Others');

-- CreateEnum
CREATE TYPE "EthinicityEnum" AS ENUM ('White', 'Black', 'AsianAmerican', 'EastAsian', 'SouthEastAsia', 'SouthAsian', 'MiddleEastern', 'Pacific', 'Hispanic');
