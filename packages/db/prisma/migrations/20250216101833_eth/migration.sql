/*
  ...
  - The values [AsianAmerican,EastAsian,SouthEastAsia,SouthAsian,MiddleEastern] on the enum `EthinicityEnum` will be removed. If these variants are still used in the database, this will fail.
